...
const supabaseAnonKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impxc2h2aW13cGVrbXdzeWZmZGFiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDQyNDk4ODksImV4cCI6MjAxOTgyNTg4OX0.cwOFsxJqgcxBPnGV47a8KnvzlQKoXzEs2r1cdxysVAs'
...
const candidates = [
  {
    id: 1,
    name: 'Kandidat 1 Hanum Khairana Fatmah',
    imageUrl: '/images/hanum.jpg',
  },
  ...
  {
    id: 4,
    name: 'Kandidat 4 Resky Awaluddin Fajar Syarif',
    imageUrl: '/images/resky.jpg',
  },
  {
    id: 5,
    name: 'Kandidat 5 Mochammad Itmamul Wafa',
    imageUrl: '/images/wafa.jpg',
  },
]
  ...
  const handleSubmit: FormEventHandler = async (e) => {
    ...
    try {
      const { data, error } = await supabase
        .from('votings')
        .insert([{ email: email, voting: selectedCandidate }])
    ...
    <div>
      ...
      <div className='bg-indigo-600 text-white text-center py-4'>
        <h1 className='text-2xl font-bold'>
          Pemilihan Ketua HIMPASIKOM UGM Periode 2024/2024
        </h1>
        ...
        <form onSubmit={handleSubmit} className='w-full max-w-4xl'>
          ...
          <div className='mt-6'>
            <p className='text-sm text-gray-500'>
              ...
              tidak bisa hadir di tempat pemilihan <br />- Satu email (email
              UGM) hanya bisa melakukan voting sekali
            </p>
          </div>
          {/* <div>
